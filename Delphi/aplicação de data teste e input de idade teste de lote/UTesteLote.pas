...
begin
  ...
  vCampos := 'Cod_Lote_Num, Data_teste, Obs_Teste, Obs_Conclusao, origem,  Idade ';
  vValues := ':Cod_Lote_Num, :detDatTeste, :Obs_Teste, :Obs_Conclusao, :origem, :Idade ';
  try
    begin
...
begin
  ...
  vCampos := 'Data_teste = :detDatTeste, idade= :idade, Obs_Teste = :Obs_Teste, Obs_Conclusao = :Obs_Conclusao';
