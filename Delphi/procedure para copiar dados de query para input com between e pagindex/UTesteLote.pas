...
type
  TFMovimentoTesteLote = class(TFPai)
    ...
    QryConsultaData_teste: TStringField;
...
//  detDat_Inicio.Date := FMenu.Parametros.vData;
...
begin
  ...
  vCampos := 'Cod_Lote_Num, Data_teste, Dat_Fim, Obs_Teste, Obs_Conclusao, origem ';
  vValues := ':Cod_Lote_Num, :detDatTeste, :Dat_Fim, :Obs_Teste, :Obs_Conclusao, :origem';
  try
    begin
