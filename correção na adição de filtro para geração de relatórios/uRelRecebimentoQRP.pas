...
begin
   ...
   with FRelRecebimentoQRP do
    begin
       ...
       vWhere := '';
       if FRelatFiltro.RadioGroup1.ItemIndex = 0 then
       begin
           qryDados.SQL.strings[28] :=  vWhere + ' and d.dat_post between :inicio  and :fim ';
       end
       else if FRelatFiltro.RadioGroup1.ItemIndex = 1 then
       begin
       ...
       qrlPeriodo.caption := 'Período: ' + formatdatetime('dd/mm/yyyy', FRelatFiltro.detDat_inicio.date) + ' a ' + formatdatetime('dd/mm/yyyy', FRelatFiltro.detDat_final.date);
